...
contract SmartContractWallet {
    ...
    mapping(address => mapping(address => bool)) newxOwnerGuardianVotedBool;
    ...
    function addGuardian(address _guardian, bool _isGuardian) public {
        require(msg.sender == owner, "you ar enot the owner, aborting");
        guardians[_guardian] = _isGuardian;
    }

    function proposeNewOwner(address payable _newOwner) public {
        require(guardians[msg.sender], "You are not guardian of this waller, aborting");
        require(newxOwnerGuardianVotedBool[_newOwner][msg.sender] == false, "You already voted, aborting");
